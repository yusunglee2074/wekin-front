<template>
  <div class="card">
    <router-link :to="{ name: 'ActivityDetail', params: { key: activityKey }}" class="image link">
      ...
      <div :style="{ 'backround-image':'url(' + imageUrl + ')','background-position': 'center center', 'height': 200 + 'px', 'background-size':'cover'}" style="position:relative;">
        <img :src="imageUrl" alt="" style="width:100%; height:100%;background-position: center center;background-size: cover;">
      </div>
